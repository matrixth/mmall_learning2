...
public class RedisShardedPool {
    ...
    public static redis.clients.jedis.ShardedJedis getJedis(){
        return pool.getResource();
    }


    public static void returnBrokenResource(redis.clients.jedis.ShardedJedis jedis){
        pool.returnBrokenResource(jedis);
    }



    public static void returnResource(redis.clients.jedis.ShardedJedis jedis){
        pool.returnResource(jedis);
    }


    public static void main(String[] args) {
        redis.clients.jedis.ShardedJedis jedis = pool.getResource();
